...
import { Column, DataTable, GetSummaryDataOptions, GetUnderlyingDataOptions } from '../Shared/DataTableInterfaces';
import { Filter, FilterOptions, RangeFilterOptions } from '../Shared/FilterInterfaces';
import { DashboardObjectType, DashboardObjectVisibilityType, FilterUpdateType, ReplaySpeedType, SelectionUpdateType, SheetType, ZoneVisibilityType } from '../Shared/Namespaces/Tableau';
...
export interface Worksheet extends Sheet {
     ...
     *
     * @since 1.5.0 You can use the `GetSummaryDataOptions.maxRows` property to request the number of rows of data
     * to return. If unspecified, the call to `getSummaryDataAsync` requests all rows.
     ...
     * @since 1.5.0 You can specify the desired columns by field id with `columnsToIncludeById`.
...
export interface Dashboard extends Sheet {
     ...
     *
     * @param dashboardObjectVisibilityMap    A map of dashboard object ids to its desired state of visibilty.
     * @returns                               Empty promise that resolves when the visibility has been changed.
